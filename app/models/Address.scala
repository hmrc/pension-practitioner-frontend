...
object Address {
  ...
  def apply(addressLine1: String,
            addressLine2: String,
            addressLine3: Option[String],
            addressLine4: Option[String],
            postcode: Option[String],
            country: String): Address =
    new Address(addressLine1, addressLine2, addressLine3, addressLine4, postcode, country)

  def unapply(address: Address): Option[(String, String, Option[String], Option[String], Option[String], String)] =
    Some((address.addressLine1, address.addressLine2, address.addressLine3, address.addressLine4, address.postcode, address.country))
