...
class UKAddressFormProvider @Inject()(countryOptions: CountryOptions) extends AddressMappings {
  def apply(): Form[Address] = Form(
    mapping(
      ...
      "country" -> ukCountryMapping(
        countryOptions,"error.country.required",
        "error.country.invalid.uk"
      )
