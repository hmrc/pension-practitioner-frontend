...
import forms.mappings.{AddressMappings, Constraints}
  ...
  def formWithAddressField(
    ...
    s"behave like a form with required address field $fieldName" should {
      ...
      behave like fieldWithMaxLength(
        form,
        fieldName,
        maxLength = AddressMappings.maxAddressLineLength,
        lengthError = FormError(fieldName, keyAddressLength, Seq(AddressMappings.maxAddressLineLength))
      )
