...
class IndividualPhoneControllerSpec extends ControllerSpecBase with MockitoSugar with NunjucksSupport
  ...
  private def onPageLoadUrl: String = routes.IndividualPhoneController.onPageLoad(NormalMode).url
  private def submitUrl: String = routes.IndividualPhoneController.onSubmit(NormalMode).url
