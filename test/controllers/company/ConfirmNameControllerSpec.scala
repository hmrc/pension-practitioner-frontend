...
import forms.company.ConfirmNameFormProvider
...
class ConfirmNameControllerSpec extends ControllerSpecBase with MockitoSugar with NunjucksSupport with JsonMatchers with OptionValues with TryValues {
  ...
  val formProvider = new ConfirmNameFormProvider()
  val form = formProvider()

  def confirmNameRoute = routes.ConfirmNameController.onPageLoad().url
  ...
  "ConfirmName Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      templateCaptor.getValue mustEqual "company/confirmName.njk"
