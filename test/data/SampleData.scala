...
object SampleData {
  ...
  val userAnswersFullJourneyCompanyUK:UserAnswers = {
    ...
    .setOrException(pages.company.CompanyAddressListPage, tolerantAddress)
  ...
  val userAnswersFullJourneyPartnershipUK:UserAnswers = {
    UserAnswers()
      ...
      .setOrException(pages.partnership.PartnershipAddressListPage, tolerantAddress)
  ...
  val userAnswersFullJourneyIndividualUK:UserAnswers = {
    UserAnswers()
      ...
      .setOrException(IndividualAddressListPage, tolerantAddress)
